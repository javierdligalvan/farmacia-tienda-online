...
| Tipo regulatorio | **Complemento alimenticio — no es un medicamento** |

**Cómo actúa:** Sinergia de cuatro plantas con tradición en el apoyo a la circulación venosa. El **Rusco** (Ruscus aculeatus) actúa como tónico vascular y ayuda a mantener el tono de los pequeños vasos de las piernas. La **Centella asiática** favorece la microcirculación y la resistencia de la pared vascular. La **Vid Roja** aporta antioxidantes que protegen los capilares del estrés oxidativo. El **Hamamelis** tiene efecto astringente venoso y contribuye a reducir la fragilidad capilar. Los cuatro actúan en sinergia en extractos **liofilizados** — una forma de concentración que preserva mejor los principios activos que el polvo simple o las tinturas.

> **Aviso legal (complemento alimenticio):** No diseñado para diagnosticar, tratar ni prevenir enfermedades. No sustituye una dieta variada y equilibrada ni un tratamiento médico prescrito.
...
|---|---|---|---|---|---|
| 1 | `capsulas para piernas pesadas sin receta farmacia` | Long-tail | Transaccional | Baja | H1, Title, URL |
| 2 | `fisioven plus capsulas precio online farmacia` | Long-tail marca | Transaccional | Muy baja | Meta description |
| 3 | `suplemento microcirculacion piernas rusco centella` | Long-tail | Transaccional | Muy baja | H2, cuerpo |
| 4 | `remedios naturales para piernas pesadas y cansadas` | Long-tail | Informacional | Baja | FAQs, cuerpo |
| 5 | `piernas hinchadas tratamiento natural sin receta` | Síntoma | Informacional | Baja | Descripción, FAQs |
| 6 | `rusco centella vid roja capsulas para la circulacion` | Ingrediente | Informacional | Muy baja | Descripción, H2 |
| 7 | `diferencia fisioven capsulas y gel piernas pesadas` | Comparativa | Informacional | Muy baja | FAQs, tabla comparativa |
| 8 | `fisioven plus embarazo lactancia capsulas circulacion` | Seguridad | Informacional | Muy baja | FAQs |
| 9 | `cuanto tiempo tomar capsulas circulacion piernas pesadas` | Duración | Informacional | Muy baja | FAQs |
| 10 | `daflon vs fisioven plus capsulas piernas` | Comparativa | Comercial | Baja | FAQs, tabla comparativa |
| 11 | `suplemento circulacion venosa farmacia sin receta` | Long-tail | Transaccional | Baja | Cuerpo, categoría |
| 12 | `comprar fisioven plus capsulas farmacia Valladolid` | Local | Transaccional | Muy baja | Cuerpo, meta description |
...
🔵 **H1:**
```
FisioVen Plus cápsulas para piernas pesadas — microcirculación natural sin receta
```
  ...
  "@graph": [
    {
      ...
      "description": "Complemento alimenticio Aboca con Rusco, Centella asiática, Vid Roja y Hamamelis en extractos liofilizados para favorecer la microcirculación de las piernas. 50 cápsulas de 500 mg. Sin receta.",
      "brand": {
        "@type": "Brand",
        "name": "Aboca"
      },
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿Para qué sirven las cápsulas FisioVen Plus?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "FisioVen Plus cápsulas es un complemento alimenticio para favorecer la microcirculación de las piernas. Sus cuatro plantas — Rusco, Centella asiática, Vid Roja y Hamamelis — actúan en sinergia para ayudar a reducir la sensación de piernas pesadas, cansadas o con ligera hinchazón. No es un medicamento."
          }
        },
        {
          "@type": "Question",
          "name": "¿Cuál es la diferencia entre FisioVen Plus cápsulas y FisioVen bioGel?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Las cápsulas actúan desde dentro (vía oral, efecto sistémico sobre la circulación). El gel actúa desde fuera (aplicación tópica en masaje, alivio local e inmediato de la sensación de pesadez y calor). Son complementarios y pueden usarse simultáneamente para un abordaje completo de la pesadez de piernas."
          }
        },
        {
          "@type": "Question",
          "name": "¿Se pueden combinar FisioVen Plus cápsulas y FisioVen bioGel al mismo tiempo?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sí, es la combinación recomendada para un abordaje completo. Las cápsulas actúan de forma constante durante todo el día y el gel aporta alivio inmediato con el masaje al final de la jornada. No existe interacción entre ambos al ser vías completamente distintas (oral y tópica)."
          }
        },
        {
          "@type": "Question",
          "name": "¿Es mejor Daflon o FisioVen Plus para las piernas pesadas?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Son productos de distinta naturaleza. Daflon 500 mg es un medicamento (diosmina + hesperidina) con indicaciones terapéuticas reconocidas para la insuficiencia venosa crónica. FisioVen Plus es un complemento alimenticio de cuatro plantas para el apoyo nutricional de la microcirculación. Para insuficiencia venosa diagnosticada, consulta al médico. Para apoyo natural cotidiano, consulta al farmacéutico."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "¿FisioVen Plus cápsulas es apto para embarazadas?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No se recomienda su uso durante el embarazo ni la lactancia sin supervisión médica previa. Algunos ingredientes como el Rusco se usan con precaución en estas etapas. Consulta siempre a tu médico o farmacéutico antes de tomar cualquier complemento alimenticio durante el embarazo."
          }
        }
      ]
    },
...
> **Nota cross-selling:** El enlace al FisioVen bioGel es el más prioritario — ubicar también en la descripción larga del producto (en la sección "¿Se puede combinar con FisioVen bioGel?") con un botón o enlace de texto visible.
...
- [x] Jerarquía H1 > H2 > H3 correcta (H1 arriba del todo en la ficha)
- [x] JSON-LD Product + additionalType DietarySupplement + FAQPage + BreadcrumbList (4 niveles)
- [x] gtin13 y sku incluidos en el JSON-LD
- [ ] Imágenes con alt-text *(pendiente de subir imágenes — alt texts definidos en § MAPA)*

### SEO Contenido
- [x] Keyword principal en: URL, H1, Title, primeras 100 palabras del cuerpo
- [x] Keyword secundaria (`fisioven plus capsulas precio online farmacia`) en meta description
- [x] Variantes semánticas (`microcirculación`, `piernas cansadas`, `extracto liofilizado`) en cuerpo y FAQs
- [x] Sin keyword stuffing — densidad natural
- [x] Contenido único, no copiado del prospecto oficial

### GEO (Citabilidad por IAs)
- [x] 10 FAQs con respuesta directa en la primera frase (estructura snippet-ready)
- [x] Tabla comparativa con datos verificables y nota de cautela YMYL
- [x] Mención a Aboca, extractos liofilizados y metodología de planta completa (autoridad verificable)
- [x] Aviso legal complemento alimenticio incluido (dos veces: análisis y cuerpo)
- [x] Señal de alarma (cuándo ir al médico) — E-E-A-T / YMYL
- [x] Precaución embarazo explicada con justificación (Rusco / uso cauto)
- [x] Datos estructurados FAQPage con 6 preguntas en el JSON-LD
...
- [x] Enlazado interno al bioGel marcado como prioritario para cross-sell
